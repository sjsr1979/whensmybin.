...
// A hand-drawn-style curly arrow, used as a decorative pointer at the
// postcode box.
function curlyArrow(color = "currentColor", size = 70) {
  return `
    <svg width="${size}" height="${size}" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M88,14 C55,-4 12,10 10,40 C8,66 40,72 44,50 C47,32 24,27 21,42" stroke="${color}" stroke-width="5" stroke-linecap="round" fill="none"/>
      <path d="M12,53 L21,42 L32,55" stroke="${color}" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
    </svg>
  `;
}

module.exports = { colorDot, binIllustration, curlyArrow };
