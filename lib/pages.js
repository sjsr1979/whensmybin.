...
function renderSidebar(council, currentTownSlug) {
  ...
  return `
    <a class="sidebar-official-link" href="${council.officialUrl}" target="_blank" rel="noreferrer">
      <span>Official ${council.name} bin page</span>
      <span class="sidebar-official-arrow">→</span>
    </a>
    ${relatedSection}
    ${renderReadingList()}
  `;
  ...
  return `
    <div class="sidebar-reading">
      ...
      <ul class="sidebar-list">
        <li><a href="https://www.recyclenow.com/how-to-recycle/household-recycling" target="_blank" rel="noreferrer">How to recycle at home</a></li>
        <li><a href="https://www.recyclenow.com/recycle-an-item" target="_blank" rel="noreferrer">What goes in which bin (A-Z)</a></li>
        <li><a href="https://www.recyclenow.com/how-to-recycle/how-to-recycle-food-waste" target="_blank" rel="noreferrer">Cutting down on food waste</a></li>
      </ul>
    </div>
  `;
}
